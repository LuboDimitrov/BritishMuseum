function justifiedGrid(i){
    ...
    function n(i){
        loadJSON("https://britishmuseum.info/data/british.json", function (datos) {
            fotos_gallery = datos.datosExtra[0].gallery;

            i.each(function(i){
                $(this).css("padding",o+"px"),
                $(this).attr("data-index",i),
                $(this).attr('alt','fotogallery'),
                $(this).attr("src",fotos_gallery[i]),
    ...
    function t(){
        $(window).width()>=960&&(max_line_score=8),
        $(window).width()>=660&&$(window).width()<=960&&(max_line_score=6),
        $(window).width()<=660&&(max_line_score=4);
    ...
    function s(){
        lines.forEach(function(i,e){
            if(line_score[e]>=max_line_score-1){
                ...
                var d=[],u=0;for(f=0;o-1>=f;f++){
                    for(j=0;j<=o-1;j++)u+=a[j]/a[f];
                    var c=(n-(o-1)*t)/u;d.push(c),u=0
                }
                var l=d[0]/a[0],f=0;
                i.forEach(function(i,e){
                    i.css({height:l,width:d[f]}),
                    i.animate({opacity:1},500),f+=1
                })
            }else{
                i.length;
                if($theContainer=h,line_score[e]<=max_line_score/2)var n=$theContainer.width()/2-2;
                else var n=$theContainer.width()-$theContainer.width()/3-2;
                var t=0,s=[],r=[],a=[],o=0;
                i.forEach(function(i,e){
                    var n=i.width(),t=i.height();
                    s.push(n),r.push(t),a.push(n/t),o+=1
    ...
    this.reInitGrid=function(){
        r.each(function(){
            $(this).attr("style","padding: 15px; height: 126.471px; width: 224.695px; opacity: 1;")
        }),
        n(r),t(),s()
    },
    this.initGrid=function(){
        ...
        $(window).on("resize",function(){i.reInitGrid()})
    }
}